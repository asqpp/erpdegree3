...
$(document).ready(function() {
    ...
    $('#checkListStockList').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'report/report/cloudsubset_checkStocklist',
            data: {
...
$(document).ready(function() {
    ...
    for (var i = 0; i < taxn; i++) {
        ...
        $("#rpttax" + i).html(sum.toLocaleString(undefined, {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
        }));
...
$(document).ready(function() {
    ...
    var mydatatable = $('#CustomerList').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'customer/customer/cloudsubset_CheckCustomerList',
            "data": function(data) {
...
function customerdelete(id) {
    ...
    if (r == true) {
        $.ajax({
            url: base_url + "customer/customer/cloudsubset_delete/" + id,
            type: "GET",
            success: function(r) {
                toastr["success"](r);
...
$(document).ready(function() {
    ...
    var mydatatable = $('#Credit_customerList').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'customer/customer/cloudsubset_CheckCreditCustomerList',
            "data": function(data) {
                data.csrf_test_name = CSRF_TOKEN;
                data.customer_id = $('#customer_id').val();
                data.customfiled = $("select[name='customsearch[]']").val();
...
$(document).ready(function() {
    ...
    var mydatatable = $('#paid_CustomerList').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'customer/customer/cloudsubset_CheckPaidCustomerList',
            "data": function(data) {
                data.csrf_test_name = CSRF_TOKEN;
                data.customer_id = $('#customer_id').val();
                data.customfiled = $("select[name='customsearch[]']").val();
...
$(document).ready(function() {
    ...
    var mydatatable = $('#supplierList').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'supplier/supplier/cloudsubset_ChecksupplierList',
            "data": function(data) {
                data.csrf_test_name = CSRF_TOKEN;
...
function supplierdelete(id) {
    ...
    if (r == true) {
        $.ajax({
            url: base_url + "supplier/supplier/cloudsubset_delete/" + id,
            type: "GET",
            success: function(r) {
                toastr["success"](r);
                setTimeout(function() {}, 5000);
...
function broker_form() {
    ...
    var base_url = $("#base_url").val();
    if (broker_id !== '') {
        var form_url = base_url + 'edit_broker/' + broker_id;
    } else {
        var form_url = base_url + 'add_broker';
    }


    if (broker_name == '') {
        $("#broker_name").focus();
        toastr["error"]("broker name must be required");
        setTimeout(function() {}, 500);
        return false;
    }
...
$(document).ready(function() {
    ...
    var broker_id = $('#broker_id').val();
    var base_url = $("#base_url").val();
    var mydatatable = $('#brokerList').DataTable({
        responsive: true,
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'broker/broker/cloudsubset_CheckbrokerList',
            "data": function(data) {
                data.csrf_test_name = CSRF_TOKEN;
...
function brokerdelete(id) {
    var base_url = $("#base_url").val();
    var r = confirm("Are you sure");
    if (r == true) {
        $.ajax({
            url: base_url + "broker/broker/cloudsubset_delete/" + id,
            type: "GET",
            success: function(r) {
                toastr["success"](r);
                setTimeout(function() {}, 5000);
...
//Insert broker
$("#insert_broker").validate();
$("#validate").validate();

//Update broker
$("#broker_update").validate();
function salesman_form() {
    var form = $("#salesman_form");
    var salesman_id = $("#salesman_id").val();
    var salesman_name = $("#salesman_name").val();
    var base_url = $("#base_url").val();
    if (salesman_id !== '') {
        var form_url = base_url + 'edit_salesman/' + salesman_id;
    } else {
        var form_url = base_url + 'add_salesman';
    }


    if (salesman_name == '') {
        $("#salesman_name").focus();
        toastr["error"]("salesman name must be required");
        setTimeout(function() {}, 500);
        return false;
    }
...
$(document).ready(function() {
    ...
    var salesman_id = $('#salesman_id').val();
    var base_url = $("#base_url").val();
    var mydatatable = $('#salesmanList').DataTable({
        responsive: true,
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'salesman/salesman/cloudsubset_ChecksalesmanList',
            "data": function(data) {
                data.csrf_test_name = CSRF_TOKEN;
                data.salesman_id = $('#salesman_id').val();
                data.customfiled = $("select[name='customsearch[]']").val();
            },
        },
        'columns': [{
...
function salesmandelete(id) {
    var base_url = $("#base_url").val();
    var r = confirm("Are you sure");
    if (r == true) {
        $.ajax({
            url: base_url + "salesman/salesman/cloudsubset_delete/" + id,
            type: "GET",
            success: function(r) {
                toastr["success"](r);
                setTimeout(function() {}, 5000);
...
//Insert salesman
$("#insert_salesman").validate();
$("#validate").validate();
//Update salesman
$("#salesman_update").validate();
//Update customer
