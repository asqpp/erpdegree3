  ...
  // Counts and limit for purchase order
    ...
    function calculate_store(sl) {
      ...
      $("#total_vat_amnt").val(v.toFixed(2, 2)),
        ...
        if (purchase_edit_page == 1 ) {
            ...
            var url= base_url + "purchase/purchase/cloudsubset_showpaymentmodal";
            $.ajax({
                type: "post",
                url: url,
    ...
    var options = {
        ...
        $.ajax( {
          url: base_url + "purchase/purchase/cloudsubset_product_search_by_supplier",
          method: 'post',
          dataType: "json",
          data: {
            term: request.term,
       ...
       select: function( event, ui ) {
          ...
          var  supplier_id=$('#supplier_id').val();
            ...
            $.ajax({
                type: "POST",
                url: base_url+"purchase/purchase/cloudsubset_retrieve_product_data",
