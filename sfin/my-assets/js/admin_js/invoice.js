...
function addInputField_invoice(t) {
   ...
   if (count == limits)
      ...
      e.innerHTML = "<td><input type='text' name='product_name' onkeypress='invoice_productList(" + count +
         ...
         "' name='product_id[]' id='SchoolHiddenId'/></td><td><input type='text' name='sum_insured[]' id='sum_insured_" + count +
         "' class='form-control text-left sum_insured' tabindex='" + tab2 + "' /></td><td><input type='text' name='premium_amount[]' id='premium_amount_" + count +
         "' class='form-control text-left premium_amount' tabindex='" + tab3 + "' value='0.00' /></td><td><input type='text' name='premium_vat[]' id='premium_vat_" + count +
         "' class='form-control text-left premium_vat' tabindex='" + tab4 + "' value='0' /></td><td><input type='text' name='total_premium_amount[]' id='total_premium_amount_" + count +
         "' class='form-control text-left total_premium_amount' tabindex='" + tab5 + "' value='0.00' /></td><td><input type='text' name='gross_commission[]' id='gross_commission_" + count +
         "' class='form-control text-left gross_commission' tabindex='" + tab6 + "' value='0' /></td><td><input type='text' name='gross_commission_amount[]' id='gross_commission_amount_" + count +
         "' class='form-control text-left gross_commission_amount' tabindex='" + tab7 + "' value='0.00' /></td><td><input type='text' name='gross_commission_vat[]' id='gross_commission_vat_" + count +
         "' class='form-control text-left gross_commission_vat' tabindex='" + tab8 + "' value='0' /></td><td><input type='text' name='total_gross_commission_amount[]' id='total_gross_commission_amount_" + count +
         "' class='form-control text-left total_gross_commission_amount' tabindex='" + tab9 + "' value='0.00' /></td><td><input type='text' name='broker_commission[]' id='broker_commission_" + count +
         "' class='form-control text-left broker_commission' tabindex='" + tab10 + "' value='0' /></td><td><input type='text' name='broker_commission_amount[]' id='broker_commission_amount_" + count +
         "' class='form-control text-left broker_commission_amount' tabindex='" + tab11 + "' value='0.00' /></td><td><input type='text' name='aggregator_commission[]' id='aggregator_commission_" + count +
         "' class='form-control text-left aggregator_commission' tabindex='" + tab12 + "' value='0' /></td><td><input type='text' name='aggregator_commission_amount[]' id='aggregator_commission_amount_" + count +
         "' class='form-control text-left aggregator_commission_amount' tabindex='" + tab13 + "' value='0.00' /></td><td><input type='text' name='salesman_commission[]' id='salesman_commission_" + count +
         "' class='form-control text-left salesman_commission' tabindex='" + tab14 + "' value='0' /></td><td><input type='text' name='salesman_commission_amount[]' id='salesman_commission_amount_" + count +
         "' class='form-control text-left salesman_commission_amount' tabindex='" + tab15 + "' value='0.00' /></td><td><input type='text' name='receivable_amount[]' id='receivable_amount_" + count +
         "' class='form-control text-left receivable_amount' tabindex='" + tab16 + "' /></td><td><input type='text' name='not_receivable[]' id='not_receivable_" + count +
         "' class='form-control text-left not_receivable' tabindex='" + tab17 + "' /></td><td>" + tbfild + "<input type='hidden' id='all_discount_" + count +
         "' class='total_discount dppr' name='discount_amount[]'/><button tabindex='" + tab5 + "' style='text-align: right;' class='btn btn-danger' type='button' value='Delete' onclick='deleteRow_invoice(this)'><i class='fa fa-close'></i></button></td>",
...
//          " valid' value='None' readonly='' aria-invalid='false' type='text'></td><td> <input type='text' name='product_quantity[]' value='1' required='required' onkeyup='cloudsubset_invoice_quantity_calculate(" + 
//          count + ");' onchange='cloudsubset_invoice_quantity_calculate(" + count + ");' id='total_qntt_" + count + "' class='common_qnt total_qntt_" + 
//          count + " form-control text-right'  placeholder='0.00' min='0' tabindex='" + tab3 + "'/></td><td><input type='text' name='product_rate[]' onkeyup='cloudsubset_invoice_quantity_calculate(" + 
//          count + ");' onchange='cloudsubset_invoice_quantity_calculate(" + count + ");' id='price_item_" + count + "' class='common_rate price_item" + 
//          count + " form-control text-right' required placeholder='0.00' min='0' tabindex='" + tab4 + "'/></td><td><input type='text' name='discount[]' onkeyup='cloudsubset_invoice_quantity_calculate(" 
//          + count + ");' onchange='cloudsubset_invoice_quantity_calculate(" + count + ");' id='discount_" + count + "' class='form-control text-right common_discount' placeholder='0.00' min='0' tabindex='" + tab5 + 
...
//          "' onkeyup='cloudsubset_invoice_quantity_calculate(" + count + ");' onchange='cloudsubset_invoice_quantity_calculate(" + count + ");' class='form-control text-right common_discount' placeholder='0.00' min='0' tabindex='" + tab14 + 
...
function cloudsubset_invoice_quantity_calculate(item) {
   ...
   if (available_quantity != 0) {
      if (parseInt(quantity) > parseInt(available_quantity)) {
         ...
         for (var i = 0; i < taxnumber; i++) {
            ...
            cloudsubset_invoice_quantity_calculate(item);
         }
      }
   }
   ...
   if (invoice_edit_page == 1) {
      ...
      var url = base_url + "invoice/invoice/cloudsubset_showpaymentmodal";
      $.ajax({
         type: "post",
         url: url,
         data: {
...
function invoice_paidamount() {
   ...
   var t = $("#grandTotal").val(),
      a = $("#paidAmount").val(),
      nt = parseFloat(t, 10) - parseFloat(hpa, 10) - parseFloat(a, 10);
...
function deleteRow_invoice(t) {
   ...
   if (1 == a)
      ...
      $("#normalinvoice > tbody > tr td input.common_qnt").each(function () {
         ...
         $(this).attr('onkeyup', 'cloudsubset_invoice_quantity_calculate(' + common_qnt + ');');
         $(this).attr('onchange', 'cloudsubset_invoice_quantity_calculate(' + common_qnt + ');');
      });
      var common_rate = 1;
...
function customer_autocomplete(sl) {
   ...
   var options = {
      ...
      source: function (request, response) {
         ...
         $.ajax({
            url: base_url + "invoice/invoice/cloudsubset_customer_autocomplete",
            method: 'post',
            dataType: "json",
            data: {
               term: request.term,
...
//   var premium_amount = 'premium_amount_' + sl;
//   var premium_vat = 'premium_vat_' + sl;
//   var total_premium_amount = 'total_premium_amount_' + sl;
//   var gross_commission = 'gross_commission_' + sl;
//   var gross_commission_amount = 'gross_commission_amount_' + sl;
//   var gross_commission_vat = 'gross_commission_vat_' + sl;
//   var total_gross_commission_amount = 'total_gross_commission_amount_' + sl;
//   var broker_commission = 'broker_commission_' + sl;
//   var broker_commission_amount = 'broker_commission_amount_' + sl;
//   var aggregator_commission = 'aggregator_commission_' + sl;
//   var aggregator_commission_amount = 'aggregator_commission_amount_' + sl;
//   var salesman_commission = 'salesman_commission_' + sl;
//   var salesman_commission_amount = 'salesman_commission_amount_' + sl;
   var csrf_test_name = $('[name="csrf_test_name"]').val();
   var base_url = $("#base_url").val();
   ...
   var options = {
      ...
      source: function (request, response) {
         ...
         $.ajax({
            url: base_url + "invoice/invoice/cloudsubset_autocomplete_product",
            method: 'post',
            dataType: "json",
            data: {
               term: request.term,
      ...
      select: function (event, ui) {
         ...
         $.ajax({
            type: "POST",
            url: base_url + "invoice/invoice/get_product_info",
            data: {
               product_id: id,
               csrf_test_name: csrf_test_name
            },
            ...
            //   $('#' + premium_amount).val(obj.premium_amount);
            //   $('#' + premium_vat).val(obj.premium_vat);
            //   $('#' + total_premium_amount).val(obj.total_premium_amount);
            //   $('#' + gross_commission).val(obj.gross_commission);
            //   $('#' + gross_commission_amount).val(obj.gross_commission_amount);
            //   $('#' + gross_commission_vat).val(obj.gross_commission_vat);
            //   $('#' + total_gross_commission_amount).val(obj.total_gross_commission_amount);
            //   $('#' + broker_commission).val(obj.broker_commission);
            //   $('#' + broker_commission_amount).val(obj.broker_commission_amount);
            //   $('#' + aggregator_commission).val(obj.aggregator_commission);
            //   $('#' + aggregator_commission_amount).val(obj.aggregator_commission_amount);
            //   $('#' + salesman_commission).val(obj.salesman_commission);
            //   $('#' + salesman_commission_amount).val(obj.salesman_commission_amount);
            //   // $('#paidAmount').val(obj.paid_amount);
            //   $('#dueAmmount').val(obj.due);
            //   $('#hiddenpaidAmount').val(obj.paid_amount);
            //   $('#hiddendueAmmount').val(obj.due);
            //   $(".grandTotalamnt").val(obj.total_premium_amount);
            //   $(".vat_total").val(obj.premium_vat);
...
//                             cloudsubset_invoice_quantity_calculate(sl);
...
function invoice_product_batch(sl) {
   ...
   $.ajax({
      url: base_url + "invoice/invoice/cloudsubset_batchwise_productprice",
      method: 'post',
      dataType: "json",
      data: {
         prod_id: prod_id,
...
//Invoice Paid Amount
    "use strict";
function invoice_commissionpaidamount() {
    var total_discount = $('#total_discount_ammount').val();
    var  spa = parseFloat($("#salesmanpaidAmount").val(), 10);
    var t = $(".salesman_commission_amount").val(),
    i = $(".salesman_incentive_amount").val(),
    nt = (parseFloat(t, 10) + parseFloat(i, 10)) - parseFloat(spa, 10) - parseFloat(total_discount, 10);
