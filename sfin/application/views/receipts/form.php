...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">
        <i class="fas fa-money-check-alt mr-2"></i>New Receipt Voucher
    </h1>

    <div class="bg-white rounded-lg shadow p-6">
        <?php echo form_open('receipts/add', array('id' => 'receiptForm')); ?>
        ...
        <div class="mt-6 flex justify-end gap-4">
            <a href="<?php echo base_url('receipts'); ?>" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</a>
