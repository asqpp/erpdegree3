                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="product_quantity[]" required=""
                                        onkeyup="cloudsubset_invoice_quantity_calculate(1);"
                                        onchange="cloudsubset_invoice_quantity_calculate(1);"
                                ...
                                <td class="invoice_fields">
                                    <input type="text" name="product_rate[]" id="price_item_1"
                                        ...
                                        onkeyup="cloudsubset_invoice_quantity_calculate(1);"
                                        onchange="cloudsubset_invoice_quantity_calculate(1);" placeholder="0.00" min="0" />
                                </td>
                                <!-- Discount -->
                                <td>
                                    <input type="text" name="discount[]" onkeyup="cloudsubset_invoice_quantity_calculate(1);"
                                        onchange="cloudsubset_invoice_quantity_calculate(1);" id="discount_1"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" onkeyup="cloudsubset_invoice_quantity_calculate(1);"
                                        onchange="cloudsubset_invoice_quantity_calculate(1);" id="invoice_discount"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="shipping_cost" class="form-control text-right"
                                        name="shipping_cost" onkeyup="cloudsubset_invoice_quantity_calculate(1);"
                                        onchange="cloudsubset_invoice_quantity_calculate(1);" placeholder="0.00"
                                        tabindex="14" />
                                </td>
                            </tr>
                            <tr>
