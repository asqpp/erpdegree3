    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <?php echo form_open('datewise_aggregator_report', array('class' => 'form-inline', 'method' => 'get')) ?>
                <?php
                        $today = date('Y-m-d');
                        ?>
        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <span><?php echo display('aggregator_report') ?> </span>
...
<script src="<?php echo base_url('my-assets/js/admin_js/aggregator_report.js') ?>" type="text/javascript"></script>
