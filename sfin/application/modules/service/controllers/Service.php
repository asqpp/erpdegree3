...
class Service extends MX_Controller {
 ...
 public function cloudsubset_service_form(){
    ...
    public function cloudsubset_manage_service(){
    ...
    public function cloudsubset_edit_service($service_id) {
    ...
    function uploadCsv_service()
     {
        ...
        public function cloudsubset_service_invoice_form() {
        $data = array(
