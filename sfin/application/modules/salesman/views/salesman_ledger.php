            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('salesman_ledgerdata', array('class' => '', 'id' => 'validate')) ?>
                        <?php $today = date('Y-m-d'); ?>
                       <div class="col-sm-4">
                        <div class="form-group row">
                            <label for="salesman_name" class="col-sm-4 col-form-label"><?php echo display('salesman') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                                <select name="salesman_id"  class="form-control" required="">
                                    <option value=""></option>
                                   <?php foreach($salesman as $salesmans){?>
                                    <option value="<?php echo html_escape($salesmans['salesman_id'])?>"  <?php if($salesmans['salesman_id'] == $salesman_id){echo 'selected';}?>><?php echo html_escape($salesmans['salesman_name'])?></option>
                                   <?php }?>
                                </select>
                            </div>
                            </div>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span><?php echo display('salesman_ledger') ?></span>
                            <span class="padding-lefttitle">      <?php if($this->permission1->method('add_salesman','create')->access()){ ?>
                    <a href="<?php echo base_url('add_salesman') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_salesman') ?> </a>
                   <?php }?>
                <?php if($this->permission1->method('manage_salesman','read')->access()){ ?>
                    <a href="<?php echo base_url('salesman_list') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_salesman') ?> </a>
                 <?php }?></span>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div id="printableArea">
                            ...
                            <?php if ($salesman_name) { ?>
                                <div class="text-center">
                                    <h3> <?php echo $salesman_name;?> </h3>
