...
class Customer extends MX_Controller {
    ...
    public function cloudsubset_CheckCustomerList(){
     ...
     public function cloudsubset_credit_customer() {
        $data['title']             = display('credit_customer');
        $data['module']            = "customer";
        $data['page']              = "credit_customer"; 
        $data["customer_dropdown"] = $this->customer_model->cloudsubset_credit_customer_dropdown();
        $data['all_customer']      = $this->customer_model->cloudsubset_all_credit_customer(); 
        echo modules::run('template/layout', $data);
    }

     public function cloudsubset_CheckCreditCustomerList(){
    ...
    public function cloudsubset_paid_customer() {
        $data['title']             = display('paid_customer');
        $data['module']            = "customer";
        $data['page']              = "paid_customer"; 
        $data["customer_dropdown"] = $this->customer_model->cloudsubset_paid_customer_dropdown();
        $data['all_customer']      = $this->customer_model->cloudsubset_all_paid_customer(); 
        echo modules::run('template/layout', $data);
        
    }
    
     public function cloudsubset_CheckPaidCustomerList(){
        // GET data
        $postData = $this->input->post();
        $data = $this->customer_model->cloudsubset_getPaidCustomerList($postData);
        echo json_encode($data);
    } 
  ...
  public function cloudsubset_form($id = null)
    ...
    public function cloudsubset_customer_ledger() {
    ...
    public function cloudsubset_customer_ledgerData() {
    ...
    public function cloudsubset_customer_advance() {
