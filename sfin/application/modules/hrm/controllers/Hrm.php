...
class Hrm extends MX_Controller {
    ...
    public function cloudsubset_designation_list(){
        ...
        public function cloudsubset_designation_form($id = null)
    {
       ...
       public function cloudsubset_deletedesignation($id = null) {
     ...
     /*employee part start*/
      public function cloudsubset_employee_form($id = null){
   ...
   $data['employee'] = (object)$postData = [
        ...
        public function cloudsubset_employee_list(){
        ...
        public function cloudsubset_employee_profile($id){
       ...
       public function cloudsubset_delete_employee($id = null) {
