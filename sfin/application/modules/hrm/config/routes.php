...
/*employee part*/
$route['designation_form']        = "hrm/hrm/cloudsubset_designation_form";
$route['designation_form/(:num)'] = 'hrm/hrm/cloudsubset_designation_form/$1';
$route['designation_list']        = 'hrm/hrm/cloudsubset_designation_list';
$route['employee_form']           = "hrm/hrm/cloudsubset_employee_form";
$route['employee_form/(:num)']    = 'hrm/hrm/cloudsubset_employee_form/$1';
$route['employee_list']           = 'hrm/hrm/cloudsubset_employee_list';
$route['employee_profile/(:num)'] = 'hrm/hrm/cloudsubset_employee_profile/$1';
/*attendance part*/
$route['add_attendance']          = "hrm/attendance/cloudsubset_add_attendance";
$route['attendance_list']         = "hrm/attendance/manage_attendance";
$route['attendance_list/(:num)']  = "hrm/attendance/manage_attendance/$1";
$route['edit_attendance/(:num)']  = "hrm/attendance/cloudsubset_edit_attendance/$1";
$route['attendance_report']       = "hrm/attendance/cloudsubset_attendance_report";
$route['datewise_attendance_report']= "hrm/attendance/cloudsubset_datewiseattendancereport";
...
/*expense part*/
$route['add_expense_item']        = "hrm/expense/cloudsubset_expense_item_form";
$route['manage_expense_item']     = "hrm/expense/cloudsubset_expense_item_list";
$route['add_expense']             = "hrm/expense/cloudsubset_add_expense";
...
/*office loan part*/
$route['add_officeloan_person']   = "hrm/loan/cloudsubset_add_office_loan_person";
...
$route['add_office_loan']          = "hrm/loan/cloudsubset_add_office_loan";
$route['add_office_loan_payment']  = "hrm/loan/cloudsubset_add_office_loan_payment";
$route['edit_office_loan_person/(:any)']= "hrm/loan/cloudsubset_edit_office_person/$1";
/*personal loan part start*/
$route['add_person']               = "hrm/loan/cloudsubset_add_person";
$route['manage_person']            = "hrm/loan/manage_person";
$route['manage_person/(:num)']     = "hrm/loan/manage_person/$1";
$route['person_ledger/(:any)']     = "hrm/loan/cloudsubset_personal_ledger/$1";
$route['personal_loan_summary']    = "hrm/loan/cloudsubset_personal_loan_summary";
$route['add_loan']                 = "hrm/loan/cloudsubset_add_loan";
$route['add_payment']              = "hrm/loan/cloudsubset_add_payment";
