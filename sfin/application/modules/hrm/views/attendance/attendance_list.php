  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <?php if($this->permission1->method('manage_attendance','delete')->access()){ ?>            
                    <a href="<?php echo base_url("hrm/attendance/cloudsubset_delete_attendance/".$row['att_id']) ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-times" aria-hidden="true"></i></a> 
                      <?php }?>
