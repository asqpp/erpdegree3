<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <?php if ( $this->permission1->method('new_invoice', 'create')->access() || $this->permission1->method('manage_invoice', 'read')->access() || $this->permission1->method('pos_invoice', 'create')->access() || $this->permission1->method('gui_pos', 'create')->access() || $this->permission1->method('terms_list', 'read')->access() || $this->permission1->method('terms_add', 'read')->access() ) { ?>
            <li class="treeview <?php if (    $this->uri->segment('1') == "add_invoice" ||     $this->uri->segment('1') == "invoice_list" ||     $this->uri->segment('1') == "pos_invoice" ||     $this->uri->segment('1') == "gui_pos" ||     $this->uri->segment('1') == "invoice_details" ||     $this->uri->segment('1') == "invoice_pad_print" ||     $this->uri->segment('1') == "pos_print" ||     $this->uri->segment('1') == "invoice_edit" ||     $this->uri->segment('1') == "terms_list" ||     $this->uri->segment('1') == "terms_add") { echo "active"; } else { echo " "; } ?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == "add_invoice") {
                        echo "active";
                        } else {
                        echo " ";
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == "invoice_list") {
                        echo "active";
                        } else {
                        echo " ";
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == "gui_pos") {
                        echo "active";
                        } else {
                        echo " ";
                        } ?>"><a href="<?php echo base_url('gui_pos'); ?>"><?php echo display('pos_invoice'); ?></a></li>
                    <li class="treeview <?php if ($this->uri->segment('1') == "upload_invoice") {
                        echo "active";
                        } else {
                        echo " ";
                        } ?>"><a href="<?php echo base_url('upload_invoice'); ?>">Parse Invoice</a></li>
                    <?php } ?>
                    <?php if ($this->permission1->method('terms_list', 'create')->access()) { ?>
                    <li class="treeview <?php if ($this->uri->segment('1') == "terms_list") {
                        echo "active";
                        } else {
                        echo " ";
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == "terms_add") {
                        echo "active";
                        } else {
                        echo " ";
        ...
        <li class="treeview <?php echo $this->uri->segment(1) == "add_customer" || $this->uri->segment(1) == "customer_list" || $this->uri->segment(1) == "credit_customer" || $this->uri->segment(1) == "paid_customer" || $this->uri->segment(1) == "edit_customer" || $this->uri->segment(1) == "customer_ledgerdata" || $this->uri->segment(1) == "customer_ledger" || $this->uri->segment(1) == "advance_receipt" || $this->uri->segment(1) == "customer_advance" ? "active" : ''; ?>">
            ...
            <ul class="treeview-menu">
                ...
                <?php } ?>
                <?php if ($this->permission1->method('customer_advance', 'read')->access()) { ?>
        ...
        <li class="treeview <?php echo $this->uri->segment(1) == "add_supplier" || $this->uri->segment(1) == "supplier_list" || $this->uri->segment(1) == "edit_supplier" || $this->uri->segment(1) == "supplier_ledgerdata" || $this->uri->segment(1) == "supplier_ledger" || $this->uri->segment(1) == "supplier_advance" ? "active" : ''; ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?php echo $this->uri->segment(1) == "supplier_ledger" ? "active" : ''; ?>">
        ...
        <?php } ?>
        <!-- broker menu part -->
        <?php if ($this->permission1->method('add_broker', 'create')->access() || $this->permission1->method('manage_broker', 'read')->access() || $this->permission1->method('broker_ledger', 'read')->access() || $this->permission1->method('broker_advance', 'create')->access() ) { ?>
        <li
            class="treeview <?php echo $this->uri->segment(1) == "add_broker" ||     $this->uri->segment(1) == "broker_list" ||     $this->uri->segment(1) == "edit_broker" ||     $this->uri->segment(1) == "broker_ledgerdata" ||     $this->uri->segment(1) == "broker_ledger" ||     $this->uri->segment(1) == "broker_advance"
                    ? "active"
                    : ''; ?>">
            <a href="javascript:void(0)">
            <i class="metismenu-icon fa fa-user-secret"></i> <span><?php echo display('broker'); ?></span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->permission1->method('add_broker', 'create')->access()) { ?>
                <li class="<?php echo $this->uri->segment(1) == "add_broker" ? "active" : ''; ?>">
                    <a href="<?php echo base_url('add_broker'); ?>"
                        class="<?php echo $this->uri->segment(1) == "add_broker" ? "active" : null; ?>">
                    <?php echo display('add_broker'); ?>
                    </a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('manage_broker', 'read')->access()) { ?>
                <li class="<?php echo $this->uri->segment(1) == "broker_list" ? "active" : ''; ?>">
                    <a href="<?php echo base_url('broker_list'); ?>">
                    <?php echo display('broker_list'); ?>
                    </a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('broker_ledger', 'read')->access()) { ?>
                <li class="<?php echo $this->uri->segment(1) == "broker_ledger" ? "active" : ''; ?>">
                    <a href="<?php echo base_url('broker_ledger'); ?>">
                    <?php echo display('broker_ledger'); ?>
                    </a>
                </li>
                <?php } ?>
            </ul>
        ...
        <?php } ?>
        <!-- salesman menu part -->
        <?php if ($this->permission1->method('add_salesman', 'create')->access() || $this->permission1->method('manage_salesman', 'read')->access() || $this->permission1->method('salesman_ledger', 'read')->access() || $this->permission1->method('salesman_advance', 'create')->access()) { ?>
        <li
            class="treeview <?php echo $this->uri->segment(1) == "add_salesman" ||     $this->uri->segment(1) == "salesman_list" ||     $this->uri->segment(1) == "edit_salesman" ||     $this->uri->segment(1) == "salesman_ledgerdata" ||     $this->uri->segment(1) == "salesman_ledger" ||     $this->uri->segment(1) == "salesman_advance"
                    ? "active"
                    : ''; ?>">
            <a href="javascript:void(0)">
            <i class="metismenu-icon fa fa-user-secret"></i> <span><?php echo display('salesman'); ?></span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->permission1->method('add_salesman', 'create')->access()) { ?>
                <li class="<?php echo $this->uri->segment(1) == "add_salesman" ? "active" : ''; ?>">
                    <a href="<?php echo base_url('add_salesman'); ?>"
                        class="<?php echo $this->uri->segment(1) == "add_salesman" ? "active" : null; ?>">
                    <?php echo display('add_salesman'); ?>
                    </a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('manage_salesman', 'read')->access()) { ?>
                <li class="<?php echo $this->uri->segment(1) == "salesman_list" ? "active" : ''; ?>">
                    <a href="<?php echo base_url('salesman_list'); ?>">
                    <?php echo display('salesman_list'); ?>
                    </a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('salesman_ledger', 'read')->access()) { ?>
                <li class="<?php echo $this->uri->segment(1) == "salesman_ledger" ? "active" : ''; ?>">
                    <a href="<?php echo base_url('salesman_ledger'); ?>">
                    <?php echo display('salesman_ledger'); ?>
                    </a>
                </li>
                <?php } ?>
            </ul>
        ...
        <?php } ?>
        <!-- Commission Payment start -->
        <?php if ($this->permission1->method('salesman_commission', 'read')->access() || $this->permission1->method('broker_commission', 'read')->access() || $this->permission1->method('supplier_payment', 'read')->access() || $this->permission1->method('customer_payment', 'read')->access() || $this->permission1->method('fixedasset_schedule', 'read')->access() || $this->permission1->method('income_statement_form', 'read')->access() || $this->permission1->method('bank_reconciliation', 'read')->access() || $this->permission1->method('predefined_accounts', 'read')->access() || $this->permission1->method('subaccount_list', 'read')->access() || $this->permission1->method('financial_year', 'read')->access() || $this->permission1->method('opening_balance', 'create')->access() || $this->permission1->method('supplier_payment', 'create')->access() || $this->permission1->method('customer_receive', 'create')->access() || $this->permission1->method('service_payment', 'create')->access() || $this->permission1->method('debit_voucher', 'read')->access() || $this->permission1->method('credit_voucher', 'read')->access() || $this->permission1->method('aprove_v', 'read')->access() || $this->permission1->method('contra_voucher', 'read')->access() || $this->permission1->method('balance_sheet', 'read')->access() || $this->permission1->method('journal_voucher', 'read')->access() || $this->permission1->method('add_payment_method', 'create')->access() || $this->permission1->method('cash_adjustment', 'create')->access() || $this->permission1->method('payment_method_list', 'read')->access()) { ?>
        <li class="treeview <?php if ($this->uri->segment('2') == "salesman_commission" || $this->uri->segment('1') == "broker_commission" || $this->uri->segment('1') == "supplier_payment" || $this->uri->segment('1') == "customer_payment") {
            echo "active";
            } else {
            echo " ";
            } ?>">
            <a href="#">
            <i class="fa fa fa-credit-card"></i><span>Payment</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->permission1->method('salesman_commission_search', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "salesman_commission_search") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('salesman_commission_search'); ?>">Salesman Commission</a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('supplier_payment_search', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "supplier_payment_search") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('supplier_payment_search'); ?>">Supplier Payment</a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('customer_payment_search', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "customer_payment_search") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('customer_payment_search'); ?>">Customer Payment</a>
                </li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
        <!-- Receipt Payment start -->
        <?php if ($this->permission1->method('broker_receipt', 'read')->access()) { ?>
        <li class="treeview <?php if ($this->uri->segment('2') == "broker_receipt") {
            echo "active";
            } else {
            echo " ";
            } ?>">
            <a href="#">
            <i class="fa fa fa-credit-card"></i><span>Receipt</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->permission1->method('broker_receipt_search', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "broker_receipt_search") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('broker_receipt_search'); ?>">Broker Receipt</a>
                </li>
                <?php } ?>
            </ul>
        </li>
        ...
        <li class="treeview <?php if ($this->uri->segment('2') == "voucher_report" || $this->uri->segment('1') == "bank_reconciliation" || $this->uri->segment('1') == "expenditure_statement" || $this->uri->segment('1') == "expenditure_statement_report" || $this->uri->segment('1') == "receipt_payment" || $this->uri->segment('1') == "receipt_payment_report" || $this->uri->segment('1') == "bank_reconciliation_report" || $this->uri->segment('1') == "fixedasset_schedule" || $this->uri->segment('1') == "fixed_assets_report" || $this->uri->segment('1') == "income_statement_form" || $this->uri->segment('1') == "income_statement" || $this->uri->segment('1') == "aprove_v" || $this->uri->segment('1') == "add_opening_balance" || $this->uri->segment('1') == "edit_opening_balance" || $this->uri->segment('1') == "edit_voucher" || $this->uri->segment('1') == "create_debit_voucher" || $this->uri->segment('1') == "predefined_accounts" || $this->uri->segment('1') == "financial_year" || $this->uri->segment('1') == "subaccount_list" || $this->uri->segment('1') == "show_tree" || $this->uri->segment('1') == "opening_balance" || $this->uri->segment('1') == "cash_book" || $this->uri->segment('1') == "cash_book_report" || $this->uri->segment('1') == "day_book" || $this->uri->segment('1') == "day_book_report" || $this->uri->segment('1') == "bank_book" || $this->uri->segment('1') == "bank_book_report" || $this->uri->segment('1') == "general_ledger" || $this->uri->segment('1') == "sub_ledger" || $this->uri->segment('1') == "sub_ledger_report" || $this->uri->segment('1') == "accounts_report_search" || $this->uri->segment('1') == "trial_balance" || $this->uri->segment('1') == "trial_balance_report" || $this->uri->segment('1') == "profit_loss_report_search" || $this->uri->segment('1') == "profit_loss_report" || $this->uri->segment('1') == "cash_flow" || $this->uri->segment('1') == "inventory_ledger" || $this->uri->segment('1') == "coa_print" || $this->uri->segment('1') == "cashflow_form" || $this->uri->segment('1') == "coa" || $this->uri->segment('1') == "supplier_payment" || $this->uri->segment('1') == "supplier_payment_received" || $this->uri->segment('1') == "customer_payment_receipt" || $this->uri->segment('1') == "customer_receive" || $this->uri->segment('1') == "service_payment" || $this->uri->segment('1') == "cash_adjustment" || $this->uri->segment('1') == "debit_voucher" || $this->uri->segment('1') == "credit_voucher" || $this->uri->segment('1') == "create_credit_voucher" || $this->uri->segment('1') == "create_contra_voucher" || $this->uri->segment('1') == "create_journal_voucher" || $this->uri->segment('1') == "contra_voucher" || $this->uri->segment('1') == "journal_voucher" || $this->uri->segment('1') == "voucher_list" || $this->uri->segment('1') == "edit_voucher" || $this->uri->segment('1') == "balance_sheet" || $this->uri->segment('1') == "opening_balance" || $this->uri->segment('1') == "add_payment_method" || $this->uri->segment('1') == "payment_method_list") {
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "expenditure_statement") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('expenditure_statement'); ?>"><?php echo display('expenditure_statement'); ?></a></li>
                <?php } ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "receipt_payment") {
                    ...
                    echo " ";
                    } ?>"><a href="<?php echo base_url('receipt_payment'); ?>"><?php echo display('receipt_payment'); ?></a></li>
                <?php } ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "fixedasset_schedule") {
                    ...
                    echo " ";
                    } ?>"><a href="<?php echo base_url('fixedasset_schedule'); ?>"><?php echo display('fixedasset_schedule'); ?></a></li>
                <?php } ?>
                <?php if ($this->permission1->method('income_statement_form', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "income_statement_form") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('income_statement_form'); ?>"><?php echo display('income_statement_form'); ?></a></li>
                <?php } ?>
                <?php if ($this->permission1->method('create_debit_voucher', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "create_debit_voucher") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('create_debit_voucher'); ?>"><?php echo display('create_debit_voucher'); ?></a></li>
                <?php } ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "general_ledger") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('general_ledger'); ?>"><?php echo display('general_ledger'); ?></a></li>
                <?php } ?>
                <?php if ($this->permission1->method('sub_ledger', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "sub_ledger") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('sub_ledger'); ?>"><?php echo display('sub_ledger'); ?></a></li>
                <?php } ?>
                <?php if ($this->permission1->method('trial_balance', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "trial_balance") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('trial_balance'); ?>"><?php echo display('trial_balance'); ?></a></li>
                <?php } ?>
                <?php if ($this->permission1->method('profit_loss_report', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "profit_loss_report") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('profit_loss_report'); ?>"><?php echo display('profit_loss_report'); ?></a></li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "closing_form" || $this->uri->segment('1') == "closing_report" || $this->uri->segment('1') == "closing_report_search" || $this->uri->segment('1') == "todays_report" || $this->uri->segment('1') == "todays_customer_received" || $this->uri->segment('1') == "todays_customerwise_received" || $this->uri->segment('1') == "sales_report" || $this->uri->segment('1') == "datewise_sales_report" || $this->uri->segment('1') == "userwise_sales_report" || $this->uri->segment('1') == "invoice_wise_due_report" || $this->uri->segment('1') == "shipping_cost_report" || $this->uri->segment('1') == "purchase_report" || $this->uri->segment('1') == "purchase_report_categorywise" || $this->uri->segment('1') == "product_wise_sales_report" || $this->uri->segment('1') == "category_sales_report" || $this->uri->segment('1') == "sales_return" || $this->uri->segment('1') == "supplier_returns" || $this->uri->segment('1') == "tax_report" || $this->uri->segment('1') == "profit_report") {
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "sales_report") {
                    ...
                    echo " ";
                    } ?>"><a href="<?php echo base_url('sales_report'); ?>"><?php echo display('production_report'); ?></a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('aggregator_report', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "aggregator_report") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('aggregator_report'); ?>"><?php echo display('aggregator_report'); ?></a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('broker_report', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "broker_report") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('broker_report'); ?>"><?php echo display('broker_report'); ?></a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('referral_report', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "referral_report") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('referral_report'); ?>"><?php echo display('referral_report'); ?></a>
                </li>
                <?php } ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "userwise_sales_report") {
                    ...
                    href="<?php echo base_url('userwise_sales_report'); ?>"><?php echo display('user_wise_production_report'); ?></a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('commission_report', 'read')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == "commission_report") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>"><a href="<?php echo base_url('commission_report'); ?>"><?php echo display('commission_report'); ?></a>
                </li>
                <?php } ?>
                <?php if ($this->permission1->method('add_closing', 'create')->access()) { ?>
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "add_purchase" || $this->uri->segment('1') == "purchase_edit" || $this->uri->segment('1') == "purchase_list" || $this->uri->segment('1') == "purchase_details") {
            echo "active";
            } else {
            echo " ";
            } ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "add_purchase") {
                    echo "active";
                    } else {
                    echo " ";
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "purchase_list") {
                    echo "active";
                    } else {
                    echo " ";
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "designation_form" || $this->uri->segment('1') == "designation_list" || $this->uri->segment('1') == "salary_advance_view" || $this->uri->segment('1') == "salary_pay_slip" || $this->uri->segment('1') == "employee_salary_chart" || $this->uri->segment('1') == "manage_salary_advance" || $this->uri->segment('1') == "employee_salary_approval" || $this->uri->segment('1') == "employee_form" || $this->uri->segment('1') == "employee_salary_generate" || $this->uri->segment('1') == "employee_list" || $this->uri->segment('1') == "add_attendance" || $this->uri->segment('1') == "attendance_list" || $this->uri->segment('1') == "attendance_report" || $this->uri->segment('1') == "add_beneficials" || $this->uri->segment('1') == "manage_benefits" || $this->uri->segment('1') == "salary_setup" || $this->uri->segment('1') == "manage_salary_setup" || $this->uri->segment('1') == "salary_generate" || $this->uri->segment('1') == "manage_salary_generate" || $this->uri->segment('1') == "salary_payment" || $this->uri->segment('1') == "employee_salary_payment_view" || $this->uri->segment('1') == "add_expense_item" || $this->uri->segment('1') == "manage_expense_item" || $this->uri->segment('1') == "add_expense" || $this->uri->segment('1') == "manage_expense" || $this->uri->segment('1') == "expense_statement" || $this->uri->segment('1') == "add_officeloan_person" || $this->uri->segment('1') == "add_office_loan" || $this->uri->segment('1') == "add_office_loan_payment" || $this->uri->segment('1') == "manage_office_loan_person" || $this->uri->segment('1') == "office_loan_person_ledger" || $this->uri->segment('1') == "office_loan_person_ledgerdata" || $this->uri->segment('1') == "edit_office_loan_person" || $this->uri->segment('1') == "add_person" || $this->uri->segment('1') == "add_loan" || $this->uri->segment('1') == "add_payment" || $this->uri->segment('1') == "manage_person" || $this->uri->segment('1') == "personal_loan_edit" || $this->uri->segment('1') == "person_ledger" || $this->uri->segment('1') == "personal_loan_summary" || $this->uri->segment('1') == "payslip" || $this->uri->segment('1') == "edit_attendance") {
            ...
            <ul class="treeview-menu">
                ...
                <!-- Supplier menu start -->
                <li class="treeview <?php if ($this->uri->segment('1') == "designation_form" || $this->uri->segment('1') == "designation_list" || $this->uri->segment('1') == "employee_form" || $this->uri->segment('1') == "employee_list") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "add_attendance" ||         $this->uri->segment('1') == "attendance_list" ||         $this->uri->segment('1') == "attendance_report" ||         $this->uri->segment('1') == "edit_attendance"
                    ) {
                    echo "active";
                    } else {
                    echo " ";
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "add_service" || $this->uri->segment('1') == "manage_service" || $this->uri->segment('1') == "edit_service" || $this->uri->segment('1') == "add_service_invoice" || $this->uri->segment('1') == "service_details" || $this->uri->segment('1') == "manage_service_invoice" || $this->uri->segment('1') == "edit_service_invoice") {
            echo "active";
            } else {
            echo " ";
            } ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "add_service") {
                    echo "active";
                    } else {
                    echo " ";
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "manage_service") {
                    echo "active";
                    } else {
                    echo " ";
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "add_service_invoice") {
                    echo "active";
                    } else {
                    echo " ";
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "manage_service_invoice") {
                    echo "active";
                    } else {
                    echo " ";
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "add_quotation" || $this->uri->segment('1') == "manage_quotation" || $this->uri->segment('1') == "quotation_to_sales") {
            echo "active";
            } else {
            echo " ";
            } ?>">
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "invoice_wise_tax_report" || $this->uri->segment('1') == "tax_setting" || $this->uri->segment('1') == "income_tax" || $this->uri->segment('1') == "manage_income_tax" || $this->uri->segment('1') == "tax_reports" || $this->uri->segment('1') == "update_tax_setting" || $this->uri->segment('1') == "vat_tax_setting") {
            echo "active";
            } else {
            echo " ";
            } ?>">
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "company_list" || $this->uri->segment('1') == "edit_company" || $this->uri->segment('1') == "add_user" || $this->uri->segment('1') == "user_list" || $this->uri->segment('1') == "language" || $this->uri->segment('1') == "currency_form" || $this->uri->segment('1') == "currency_list" || $this->uri->segment('1') == "settings" || $this->uri->segment('1') == "mail_setting" || $this->uri->segment('1') == "app_setting" || $this->uri->segment('1') == "add_role" || $this->uri->segment('1') == "role_list" || $this->uri->segment('1') == "edit_role" || $this->uri->segment('1') == "assign_role" || $this->uri->segment('1') == "sms_setting" || $this->uri->segment('1') == "restore" || $this->uri->segment('1') == "db_import" || $this->uri->segment('1') == "editPhrase" || $this->uri->segment('1') == "phrases") {
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == "add_role" || $this->uri->segment('1') == "role_list" || $this->uri->segment('1') == "edit_role" || $this->uri->segment('1') == "assign_role") {
                    echo "active";
                    } else {
                    echo " ";
                    } ?>">
