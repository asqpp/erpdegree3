...
$route['add_payment_method']   = "account/accounts/cloudsubset_payment_method_form";
$route['add_payment_method/(:num)']   = "account/accounts/cloudsubset_payment_method_form/$1";
$route['payment_method_list']   = "account/accounts/payment_method_list";
$route['supplier_payment']= "account/accounts/cloudsubset_supplier_payment";
...
$route['cash_adjustment'] = "account/accounts/cloudsubset_cash_adjustment";
