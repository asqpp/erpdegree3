...
class Purchase extends MX_Controller {
    ...
    function cloudsubset_purchase_form() {
    ...
    public function cloudsubset_purchase_list(){
...
public function cloudsubset_purchase_details($purchase_id = null){
...
public function cloudsubset_purchase_edit_form($purchase_id = null){
    ...
    public function cloudsubset_save_purchase(){
    ...
    public function cloudsubset_update_purchase() {
    ...
    public function cloudsubset_product_search_by_supplier() {
        $supplier_id = $this->input->post('supplier_id',TRUE);
        ...
        public function cloudsubset_retrieve_product_data() {
