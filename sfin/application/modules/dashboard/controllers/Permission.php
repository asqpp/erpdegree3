...
class Permission extends MX_Controller
{
    ...
    public function cloudsubset_user_roleassign(){
    ...
    public function cloudsubset_add_role(){
    ...
    public function cloudsubset_role_list(){
    ...
    public function cloudsubset_edit_role($id){
    ...
    public function cloudsubset_role_delete($id){
