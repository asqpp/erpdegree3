...
<div class="row">
 ...
 <!--<div class="col-sm-6">-->
 <!--                       <div class="form-group row">-->
 <!--                           <label for="supplier_id" class="col-sm-4 col-form-label"><?php echo display('supplier') ?>-->
 <!--                               <i class="text-danger">*</i></label>-->
 <!--                           <div class="col-sm-8">-->
 ...
 <!--                   </div>-->
        ...
        <input type="hidden" id="supplier_list"
            ...
            name="">
        <input type="hidden" id="salesman_list"
            value='<?php if ($salesman) { ?><?php foreach($salesman as $salesmans){?><option value="<?php echo $salesmans['salesman_id']?>"><?php echo $salesmans['salesman_name']?></option><?php }}?>'
            name="">
    </div>
</div>