                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                            <input class="form-control" type="text" size="100" name="policy_type" id="policy_type" required value="" tabindex="4" />
                         </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group row">
                         ...
                         <div class="col-sm-8">
                            <input class="form-control" type="text" size="100" name="interest" id="interest" value="" tabindex="4" />
                         </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice" style="font-size: 11px;font-weight: 400;">
                      ...
                      <tbody id="addinvoiceItem">
                         <tr>
                            ...
                            <td>
                               <input type="text" name="gross_commission" id="gross_commission_1" class="form-control text-left gross_commission" tabindex="6" value="0" />
                            </td>
                            <td>
