...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">
        <i class="fas fa-file-invoice-dollar mr-2"></i>New Credit Note
    </h1>

    <div class="bg-white rounded-lg shadow p-6">
        <?php echo form_open('credit_notes/add', array('id' => 'creditNoteForm')); ?>

        <!-- Header Information -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Date</label>
                <input type="date" name="credit_note_date" value="<?php echo date('Y-m-d'); ?>" class="w-full border rounded px-3 py-2" required>
            </div>
        ...
        <div class="border-t pt-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <button type="button" onclick="addItem()" class="bg-indigo-600 text-white px-4 py-2 rounded text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-gray-50 p-4 rounded">
                    ...
                    <div class="flex justify-between text-lg font-bold border-t pt-2">
                        <span>Total:</span>
                        <span class="text-indigo-600" id="total-display">AED 0.00</span>
                    </div>
        ...
        <div class="mt-6 flex justify-end gap-4">
            <a href="<?php echo base_url('credit_notes'); ?>" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</a>
            <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
                <i class="fas fa-save mr-2"></i>Save Credit Note
            </button>
        </div>
