    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <?php echo form_open('datewise_broker_report', array('class' => 'form-inline', 'method' => 'get')) ?>
                <?php
                        $today = date('Y-m-d');
                        ?>
                <div class="form-group">
                    <label for="broker_name" ><?php echo display('broker') ?> <i class="text-danger">*</i></label>
                    <select name="broker_id" id="broker_id" class="form-control">
                        <option value=""></option>
                       <?php foreach($brokers as $broker){?>
                        <option value="<?php echo html_escape($broker['broker_id'])?>"  <?php if($broker['broker_id'] == $broker_id){echo 'selected';}?>><?php echo html_escape($broker['broker_name'])?></option>
                       <?php }?>
                    </select>
                </div>
                <div class="form-group">
        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <span><?php echo display('broker_report') ?> </span>
                        ...
                        <table class="print-table" width="100%">
                            ...
                            <tr>
                                ...
                                <td align="center" class="print-cominfo">
                                    ...
                                    <br>
                                    <strong><?php echo display('broker_report')?></strong>
                                </td>
...
<script src="<?php echo base_url('my-assets/js/admin_js/broker_report.js') ?>" type="text/javascript"></script>
