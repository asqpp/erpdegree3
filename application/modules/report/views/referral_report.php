    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <?php echo form_open('datewise_referral_report', array('class' => 'form-inline', 'method' => 'get')) ?>
                <?php $today = date('Y-m-d'); ?>
                <div class="form-group">
                    <label for="salesman_name" ><?php echo display('salesman') ?> <i class="text-danger">*</i></label>
                    <select name="salesman_id" id="salesman_id" class="form-control">
                        <option value=""></option>
                       <?php foreach($referrals as $salesmans){?>
        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <span><?php echo display('referral_report') ?> </span>
                        ...
                        <table class="print-table" width="100%">
                            ...
                            <tr>
                                ...
                                <td align="center" class="print-cominfo">
                                    ...
                                    <br>
                                    <strong><?php echo display('referral_report')?></strong>
                                </td>
...
<script src="<?php echo base_url('my-assets/js/admin_js/referral_report.js') ?>" type="text/javascript"></script>
