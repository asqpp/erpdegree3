...
class Home_model extends CI_Model {
 ...
 public function total_purchase_amount($date=null) {
    ...
    public function todays_sales_report() {
        $today = date('Y-m-d');
        $this->db->select('a.*,b.customer_name, b.customer_id, a.inv_id,a.invoice');
 ...
 //Retrieve todays_total_sales_report
    public function todays_total_sales_report() {
        $today = date('Y-m-d');
        $this->db->select("a.date,a.invoice,b.invoice_id, sum(a.total_amount) as total_amt, sum(b.total_premium_amount) as total_sale");
        $this->db->from('invoice a');
