...
$route['add_service']           = "service/service/cloudsubset_service_form";
$route['manage_service']        = "service/service/cloudsubset_manage_service";
$route['edit_service/(:num)']   = "service/service/cloudsubset_edit_service/$1";
$route['add_service_invoice']   = "service/service/cloudsubset_service_invoice_form";
