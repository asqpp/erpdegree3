...
class Expense extends MX_Controller {
    ...
    public function cloudsubset_expense_item_list(){
        ...
        public function cloudsubset_expense_item_form($id = null)
    {
    ...
    public function cloudsubset_add_expense(){
    ...
    echo Modules::run('template/layout', $data);
        ...
        public function cloudsubset_create_expense(){
