...
class Attendance extends MX_Controller {
    ...
    public function cloudsubset_add_attendance(){
      ...
      public function cloudsubset_create_atten(){
...
public function sign_out(){
   ...
   if($this->attendance_model->signout($postData)){
    ...
    public function cloudsubset_edit_attendance($id = null){
    ...
    function attendance_bulkupload()
    {
       ...
       public function cloudsubset_delete_attendance($id = null) {
       ...
       // attendance report
    public function cloudsubset_attendance_report() {
   ...
   public function cloudsubset_datewiseattendancereport() {
    $data['title']      = display('attendance_report');
