...
class Loan extends MX_Controller {
    ...
    public function cloudsubset_add_office_loan_person(){
    ...
    public function office_loan_ledger_search(){
       ...
       public function cloudsubset_add_office_loan() {
     ...
     public function cloudsubset_insert_office_loan() {
   ...
   $bankc = array(
      ...
      'IsAppove'       =>  1
        ...
        public function cloudsubset_add_office_loan_payment() {
        ...
        public function cloudsubset_submit_payment() {
        $personid       = $this->input->post('person_id',TRUE);
        $personinfo     = $this->db->select('person_name')->from('person_information')->where('person_id',$personid)->get()->row();
        $headname       = $personid.'-'.$personinfo->person_name;
        $headcid        = $this->db->select('HeadCode')->from('acc_coa')->where('HeadName',$headname)->get()->row()->HeadCode;
   ...
   $bankc = array(
      ...
      'IsAppove'       =>  1
        ...
        $this->db->insert('acc_transaction',$cc);
            ...
            public function cloudsubset_edit_office_person($person_id) {
    ...
    public function cloudsubset_add_person(){
        $data['title']      = display('add_person');
        $data['module']     = "hrm";
        ...
        public function cloudsubset_submit_person() {
        $person_id = $this->occational->generator(10);
        $data = array(
            'person_id'      => $person_id,
            'person_name'    => $this->input->post('name',TRUE),
    ...
    public function cloudsubset_personal_ledger($person_id){
    ...
    public function loan_phone_search_by_name() {
        ...
        public function cloudsubset_personal_loan_summary() {
    ...
    public function cloudsubset_add_loan(){
        ...
        public function cloudsubset_submit_loan() {
        $transaction_id = $this->occational->generator(10);
        $data = array(
            'transaction_id' => $transaction_id,
            'person_id'      => $this->input->post('person_id',TRUE),
        ...
        public function cloudsubset_add_payment(){
        $data['title']       = display('add_payment');
        $data['person_list'] = $this->loan_model->person_list_personal_loan();
        $data['module']      = "hrm";
    ...
    public function cloudsubset_submit_personal_payment() {
        $transaction_id = $this->occational->generator(10);
        $data = array(
            'transaction_id' => $transaction_id,
            'person_id'      => $this->input->post('person_id',TRUE),
