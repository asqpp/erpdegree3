                                  ...
                                  <td class="text-center"><?php if($categories->status ==1){echo display('active');}else{
                                    ...
                                    <?php }?>
                                      <?php if($this->permission1->method('manage_unit','delete')->access()){ ?>
                                        <a href="<?php echo base_url().'product/product/cloudsubset_deleteunit/'.$categories->unit_id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Want To Delete ?')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
