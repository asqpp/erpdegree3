...
class Tax extends MX_Controller {
    ...
    // ============== Tax settings ================
    public function cloudsubset_tax_settings(){
       ...
       public function cloudsubset_vat_tax_settings(){
    ...
    public function update_tax_settins(){
      ...
      public function cloudsubset_income_tax(){
       ...
       // ================ Income tax entry   ======
    public function cloudsubset_create_income_tax(){
