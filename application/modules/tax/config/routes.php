...
$route['tax_setting']            = "tax/tax/cloudsubset_tax_settings";
$route['vat_tax_setting']        = "tax/tax/cloudsubset_vat_tax_settings";
$route['update_tax_setting']     = "tax/tax/tax_settings_updateform";
$route['income_tax']             = "tax/tax/cloudsubset_income_tax";
$route['manage_income_tax']      = "tax/tax/manage_income_tax";
$route['edit_income_tax/(:num)'] = "tax/tax/edit_income_tax/$1";
$route['tax_reports']            = "tax/tax/cloudsubset_tax_report";
