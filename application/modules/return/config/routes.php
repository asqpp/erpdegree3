...
$route['return_form']           = "return/returns/cloudsubset_return_form";
$route['invoice_return']        = "return/returns/cloudsubset_invoice_return_form";
$route['invoice_return_details/(:any)']= "return/returns/invoice_return_details/$1";
$route['supplier_return']        = "return/returns/cloudsubset_supplier_return";
$route['supplier_return_details/(:any)']= "return/returns/supplier_return_details/$1";
$route['invoice_return_list']    = "return/returns/cloudsubset_invoice_return_list";
$route['invoice_return_list/(:num)']= "return/returns/cloudsubset_invoice_return_list/$1";
